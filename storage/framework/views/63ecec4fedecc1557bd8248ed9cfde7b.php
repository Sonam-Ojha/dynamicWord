    ...
    <div x-data="{ sidebarOpen: false }">
        ...
        <aside class="fe-sidebar" :class="{ 'is-open': sidebarOpen }">
            <div class="h-16 flex items-center px-5 border-b border-slate-800">
                <a href="<?php echo e(route('generate.index')); ?>" class="flex items-center gap-2">
            ...
            <nav class="px-3 py-4 space-y-1">
                <a href="<?php echo e(route('generate.index')); ?>"
                   class="fe-nav-link <?php echo e(request()->routeIs('generate.index') ? 'active' : ''); ?>">
                ...
                <a href="<?php echo e(route('generate.myDocuments')); ?>"
                   class="fe-nav-link <?php echo e(request()->routeIs('generate.myDocuments') ? 'active' : ''); ?>">
                ...
                <a href="<?php echo e(route('generate.banks')); ?>"
                   class="fe-nav-link <?php echo e(request()->routeIs('generate.banks') || request()->routeIs('generate.templates') || request()->routeIs('generate.form') ? 'active' : ''); ?>">
                ...
                <div class="pt-4 mt-4 border-t border-slate-800">
                    ...
                    <a href="<?php echo e(route('profile.edit')); ?>" class="fe-nav-link">
                    ...
                    <?php if(auth()->user()->hasAnyRole(['Super Admin', 'Admin'])): ?>
                        <a href="<?php echo e(route('admin.dashboard')); ?>" class="fe-nav-link">
                    ...
                    <div x-data="{ open: false }" class="relative">
                        <button @click="open = !open" class="flex items-center gap-2 text-sm">
                            <?php if(auth()->user()->profile_image): ?>
                                <img src="<?php echo e(asset('storage/'.auth()->user()->profile_image)); ?>" class="w-8 h-8 rounded-full object-cover" alt="">
                            <?php else: ?>
                            ...
                            <?php endif; ?>
                            <span class="hidden sm:block font-medium text-slate-800"><?php echo e(auth()->user()->name); ?></span>
                        ...
                        <div x-show="open" x-cloak @click.outside="open = false"
                            ...
                            <a href="<?php echo e(route('profile.edit')); ?>" class="block px-4 py-2 text-slate-700 hover:bg-slate-50">Profile</a>
...
<?php /**PATH C:\laragon\www\laravel\dynamicWord-main\dynamicWord-main\resources\views/frontend/layouts/app.blade.php ENDPATH**/ ?>