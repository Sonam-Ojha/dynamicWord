        ...
        <div class="auth-field">
            <div class="auth-field-row">
                ...
                <?php if(Route::has('password.request')): ?>
                    <a href="<?php echo e(route('password.request')); ?>" class="auth-link-small">Forgot?</a>
                <?php endif; ?>
            </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\laravel\dynamicWord-main\dynamicWord-main\resources\views/auth/login.blade.php ENDPATH**/ ?>